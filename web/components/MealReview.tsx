            ...
            <div key={draft.id} className="meal-review__card">
              <div className="meal-review__info">
                ...
                <p className="meal-review__totals">
                  <strong>{Math.round(totalCals)} kcal</strong> · {Math.round(totalProtein)}g
                  protein
                </p>
              </div>
              <div className="meal-review__actions">
                <button type="button" className="cta" onClick={() => onConfirm(draft.id)}>
                  Confirm
                </button>
                <button type="button" className="soft-button" onClick={() => onReject(draft.id)}>
                  Reject
                </button>
              </div>
            </div>
